...
<helpset version="2.0">
	...
	<maps>
		<mapref location="RITGenAiPlugginTest_map.xml" />
	</maps>
	<view mergetype="javax.help.UniteAppendMerge">
		<name>TOC</name>
		<label>Ghidra Table of Contents</label>
		<type>help.CustomTOCView</type>
		<data>RITGenAiPlugginTest_TOC.xml</data>
	</view>
	<view>
		<name>Search</name>
		<label>Search for Keywords</label>
		<type>help.CustomSearchView</type>
		<data engine="com.sun.java.help.search.DefaultSearchEngine">RITGenAiPlugginTest_JavaHelpSearch</data>
	</view>
	<view>
		<name>Favorites</name>
